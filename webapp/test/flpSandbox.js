		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Notification Managament",
									"targetURL": "#techcoolnotifiacationm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"techcoolnotifiacationm-display": {
								"semanticObject": "techcoolnotifiacationm",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=techcool.notifiacationm",
									"url": sap.ui.require.toUrl("techcool/notifiacationm")
								}
							}
						}
					}
